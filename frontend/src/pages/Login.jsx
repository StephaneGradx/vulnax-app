    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      ...
      <div className="hidden lg:flex items-center justify-center ">
        <img
          src="/Image.png"
          alt="Sécurité réseau"
          class="w-4/5 max-w-[600px] object-contain"
        />
      </div>
      ...
      <div className="flex items-center justify-center bg-white px-6 py-12">
        <form onSubmit={handleLogin} className="w-full max-w-md space-y-6">
          <div className="text-center">
            <h1 class="text-left font-bold text-orange-600">Ravi de vous revoir !</h1>
          </div>

          <div>
            <label class="block mb-1 text-left text-gray-700">Email</label>
            <input
              type="text"
          ...
          <div>
            <label className="block mb-1 text-left text-gray-700">Mot de passe</label>
            <input
              type="password"
              placeholder="••••••••"
              value={password}
          ...
          <p className="text-center text-left text-gray-500">
            Vous n'avez pas de compte ?{' '}
            <Link to="/register" class="text-orange-500 hover:underline">Inscrivez-vous</Link>
          </p>
        </form>
      </div>
    </div>
